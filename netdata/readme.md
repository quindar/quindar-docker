...
This is a re-use of the original NetData Github project under their GPL v3 license for convenience. We plan to have some minor customization and we will update the readme.md later.
